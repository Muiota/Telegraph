...
var Telegraph = function (ctxId, config) {
    ...
    var ChartInfo = function (xData, yInfo) {
        ...
        function drawFilterSeries(isChild, offset, exOpacity) {
            ...
            if (!isChild) {
                setGlobalAlpha(bufferNavigatorContext, opacity * (1 - exOpacity));
            } else {
                setGlobalAlpha(bufferNavigatorContext, opacity * exOpacity);
            }
    ...
    function drawSeries() {
        ...
        if (filterNeedUpdateBuffer) {
            ...
            for (_i in charts) {
                charts[_i].drawFilterSeries(vFalse, 0, inTransition() ? animationCounter : 0);
            }
